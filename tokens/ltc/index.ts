...
const TOKEN_NAME = "Loutre Coin";
const TOKEN_SYMBOL = "LTC";
const TOKEN_DESCRIPTION = "A token for otteeer loveeer";
const TOKEN_IMAGE_NAME = "logo.png"; // Replace unicorn.png with your image name
const TOKEN_IMAGE_PATH = `tokens/ltc/assets/${TOKEN_IMAGE_NAME}`;
